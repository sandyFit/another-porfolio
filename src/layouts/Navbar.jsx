...
const Navbar = () => {  
    ...
    return (                      
        <nav className='flex items-center w-[94%] max-w-full h-[50px] bg-orangi-400 fixed top-16 left-[3.5rem] py-7 z-50 
            rounded-full border-2  border-zinc-900'> 
            <div className="flex w-full justify-between items-center">
                <div className="flex w-[14%] items-center bg-zinc-800  pl-4 py-2 ml-1 rounded-full">
